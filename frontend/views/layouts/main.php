    ...
    <div class="container-fluid bg-secondary py-5 px-sm-3 px-md-5" style="margin-top: 90px;">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt text-white mr-3"></i>Avenida Marquês de Pombal, Leiria, Portugal</p>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-body mb-2" href="index.php?r=site%2Fabout"><i class="fa fa-angle-right text-white mr-2"></i>Sobre</a>
                    <a class="text-body mb-2" href="index.php?r=site%2Fservice"><i class="fa fa-angle-right text-white mr-2"></i>Servico</a>
