CREATE DATABASE  IF NOT EXISTS `projetodb_test` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `projetodb_test`;
-- MySQL dump 10.13  Distrib 8.0.30, for Win64 (x86_64)
--
-- Host: localhost    Database: projetodb_test
-- ------------------------------------------------------
...
INSERT INTO `analise` VALUES (1,'Melhor serviço para alugar carros, com vários extras. Recomendo!',5,'2022-12-14 18:36:30',3);
...
INSERT INTO `extra` VALUES (1,'Via-Verde',6.99),(2,'Cadeira de Bebé',3.99);
...
INSERT INTO `localizacao` VALUES (1,'Leiria','Rua dos testes Leiria','2400-137'),(2,'Leiria - Batalha','Rua dos teste Batalha','2440-041');
...
INSERT INTO `seguro` VALUES (1,'Seguro Directo','Seguro de responsabilidade civil',7.99),(2,'Seguro Directo','Seguro de danos próprios',12.99);
...
INSERT INTO `veiculo` VALUES (1,'VW','Golf','Diesel',29.99,'AA-11-AA','Longa descrição do veiculo','pronto',8,1,1250),(2,'Seat','Ibiza','Gasolina',17.99,'CC-33-CC','Longa descrição do veiculo','manutencao',3,1,1100),(3,'BMW','X1','Diesel',59.99,'BB-22-BB','Longa descrição do veiculo','pronto',7,2,3100);
...
-- Dump completed on 2022-12-23 19:44:48
